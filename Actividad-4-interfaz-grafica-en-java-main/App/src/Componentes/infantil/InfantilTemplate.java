 ...
 * @author empc2
 */
public class InfantilTemplate extends JPanel{
    private infantilComponent ic;
    private ObjetosGraficosServices S;
    private RecursosServices R;
    private ImageIcon des;
    private JLabel desca;
    
    public InfantilTemplate(infantilComponent ic){
         this.ic = ic;
    ...
    public void crearElementos(){
        this.des = new ImageIcon("resources/images/animaciones/peter.PNG");
