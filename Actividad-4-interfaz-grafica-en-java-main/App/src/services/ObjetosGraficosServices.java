 ...
 * @author Emanuel P
 */
public class ObjetosGraficosServices {
    ...
    private static ObjetosGraficosServices servicio;

    
    private ObjetosGraficosServices(){}
  ...
  */
  ...
  public static ObjetosGraficosServices getService() {
    if (servicio == null) servicio = new ObjetosGraficosServices();
    return servicio;
  }
